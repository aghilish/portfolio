...
export const LinkedInLogo = ({ className = "", width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
...
export const GitHubLogo = ({ className = "", width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
